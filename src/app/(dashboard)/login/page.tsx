	...
	const handleLogin = async () => {
		...
		try {
			...
			setTimeout(() => {
				...
				else window.location.href = "/create-new-file";
			}, 1200);
		} catch (err: any) {
		...
		>
			...
			<div className="bg-white rounded-2xl shadow-xl flex flex-col md:flex-row max-w-4xl w-full overflow-hidden">
				...
				<div className="md:w-1/2 bg-blue-600 text-white p-6 hidden md:flex flex-col justify-center items-center">
					<Image src="/Login.png" alt="Login" width={300} height={300} className="rounded" />
					<h2 className="text-2xl font-bold mt-4">Welcome Back!</h2>
					<p className="text-sm mt-2 text-center px-4">Log in to access your dashboard.</p>
				</div>
